...
<body>
    <div class="tab">
        <div class="tabs">
            <button id="first-tab" class="tablinks" onclick="changeTab(event, 'Felhasznalo')">Felhasználók kezelése</button>
        ...
        <div class="other-tabs">
            ...
            <div class="dropdown" style="float: right;">
                <button id="user" class="tablinks"><?php echo htmlspecialchars($username); ?></button>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th data-column="UserTypes.UserTypeName" data-dir="ASC" class="ths">UserType<i
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button
                            onclick="Modositas(<?php echo $user['UserID']; ?>, '<?php echo htmlspecialchars($user['Username']); ?>', '<?php echo htmlspecialchars($user['Password']); ?>', '<?php echo htmlspecialchars($user['UserTypeID']); ?>')"
                            class="btn btn-primary">Módosítás</button></td>
                    <td><button onclick="Torles(<?php echo $user['UserID']; ?>)" class="btn btn-danger">Törlés</button>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php else: ?>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th data-column="Items.Description" data-dir="ASC" class="ths">Description<i class="fa fa-sort"></i>
                    </th>
                    <th data-column="Items.Quantity" data-dir="ASC" class="ths">Quantity<i class="fa fa-sort"></i></th>
                    <th data-column="Items.RealQuantity" data-dir="ASC" class="ths">RealQuantity<i
                            class="fa fa-sort"></i></th>
                    <th data-column="MeasurementTypes.MeasurementType" data-dir="ASC" class="ths">MeasurementType<i
                            class="fa fa-sort"></i></th>
                    <th data-column="Shelves.ShelfName" data-dir="ASC" class="ths">ShelfName<i class="fa fa-sort"></i>
                    </th>
                    <th>Módosítás</th>
                    <th>Törlés</th>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button
                            onclick="showEditProductModal(<?php echo $product['ItemID']; ?>, '<?php echo htmlspecialchars($product['ItemName']); ?>', '<?php echo htmlspecialchars($product['Description']); ?>', <?php echo $product['Quantity']; ?>, <?php echo $product['RealQuantity']; ?>, '<?php echo htmlspecialchars($product['MeasurementType']); ?>', '<?php echo htmlspecialchars($product['ShelfName']); ?>')"
                            class="btn btn-primary">Módosítás</button></td>
                    <td><button onclick="deleteProduct(<?php echo $product['ItemID']; ?>)"
                            class="btn btn-danger">Törlés</button></td>
                </tr>
                <?php endforeach; ?>
                <?php else: ?>
                <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                        onclick="closeModal()">Mégse</button>
    ...
    <div class="modal fade" id="rogzitModal" tabindex="-1" role="dialog" aria-labelledby="rogzitModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
